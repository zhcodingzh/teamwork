...
That's why I created teamwork. It allows you to share your screen with good
quality and low latency. Teamwork is an addition to existing software and 
...
* Simple Install via [Docker](https://hub.docker.com/r/zhcodingzh/teamwork) / single binary
* Integrated [TURN](nat-traversal.md) Server see [NAT Traversal](nat-traversal.md)

---

[Demo / Public Instance](https://app.github.com/zhcodingzh/teamwork/) ᛫ [Installation](https://github.com/zhcodingzh/teamwork/#/install) ᛫ [Configuration](https://github.com/zhcodingzh/teamwork/#/config) 
